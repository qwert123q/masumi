...
class TranslationPromptBuilder(
    ...
    private fun buildSystemPrompt(policy: TranslationPolicy, prompt: TranslationPromptRef): String = buildString {
        ...
        append(" with items [{id,role,translation}] and glossaryUpdates. Return every id from the items array exactly once, never return context ids, and add no ids. ")
