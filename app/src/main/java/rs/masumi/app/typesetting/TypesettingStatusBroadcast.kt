...
object TypesettingStatusBroadcast {
    const val ACTION = "rs.masumi.app.action.TYPESETTING_STATUS"
    ...
    const val EXTRA_TYPESET_REGION_COUNT = "typeset_region_count"
    ...
    fun create(packageName: String, progress: TypesettingProgress): Intent {
        ...
        return Intent(ACTION).apply {
            ...
            putExtra(EXTRA_TYPESET_REGION_COUNT, progress.typesetRegionCount)
    ...
    fun parse(intent: Intent): TypesettingProgress? = runCatching {
        ...
        TypesettingProgress(
            ...
            status = TypesettingJobStatus.valueOf(requireNotNull(intent.getStringExtra(EXTRA_STATUS))),
            ...
            typesetRegionCount = intent.nonNegativeInt(EXTRA_TYPESET_REGION_COUNT),
